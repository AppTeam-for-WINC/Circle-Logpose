...
import '../../../controllers/controllers/tab/slide_tab_controller.dart';
...
class _SegmentedTabControlState extends State<_SegmentedTabControl>
  ...
  void _calculateTabIndicatorAlignmentRanges() {
    ...
    for (var index = 0; index < _controller!.length - 1; index++) {
      ...
      if (nextTabWidth >= tabWidth) {
        ...
        alignmentXRanges.add(Range(alignmentStartX, alignmentEndX));
        alignmentStartX = alignmentEndX;
      } else {
        final controlPoint = computedWidth + (nextTabWidth / 2);
        alignmentXRanges.add(Range(alignmentStartX, controlPoint));
        alignmentStartX = computedWidth + tabWidth - (nextTabWidth / 2);
      }

      computedWidth += tabWidth;
    }
    alignmentXRanges.add(Range(alignmentStartX, computedWidth));
  }
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundGradient =
        currentTab.backgroundGradient ?? widget.backgroundGradient;
