...
class JoinedGroupTile extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState createState() => _JoinedGroupTileState();
}

class _JoinedGroupTileState extends ConsumerState<JoinedGroupTile> {
  @override
  Widget build(BuildContext context) {
    final groupId = widget.groupId;
    final groupProfile = ref.watch(watchGroupAndIdProvider(groupId));
