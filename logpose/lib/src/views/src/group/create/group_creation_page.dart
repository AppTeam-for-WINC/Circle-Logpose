...
class GroupCreationPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<GroupCreationPage> createState() => _GroupCreateContentsState();
}

class _GroupCreateContentsState extends ConsumerState<GroupCreationPage> {
  File? image;
                        ...
                        child: GridView.count(
                          ...
                          children: <Widget>[
                            ...
                            ...ref.watch(setGroupMemberListProvider).map(
                                  (member) =>
                                      GroupMembershipTile(userProfile: member),
                                ),
                          ],
                        ),
                      ),
